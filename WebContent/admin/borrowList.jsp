	...
	<div id="c_main">
		<div id="c_nav">
			...
			<div class="inner_nav">
				<ul class="list_menu">
					<li class="list-item">
						<a href="${ctx}/admin/memberList.do" >회원 정보 조회 및 수정<span
							class="aside_arrow"><i class="fa fa-caret-right"></i></span></a></li>
					<li class="list-item active"><a href="${ctx}/book/borrowList.do" style="background: #FFFDE4;">도서 대출 정보 조회<span
							class="aside_arrow"><i class="fa fa-caret-right"></i></span></a></li>
				</ul>
			</div>
		...
		<div class="page_section">
			<div class="head_aticle">
				<h2 class="tit">
					도서 대출 정보 조회 <span class="tit_sub"> 회원들의 도서 대출 현황 리스트 입니다. </span>
				</h2>
			</div>
								...
								<table width="100%" class="board-listheader" cellpadding="0"
									...
									<tbody>
										...
										<c:if test="${not empty borrowList}">
											...
											<c:forEach items="${borrowList}" var="v" varStatus="s">
												<!--변경 : el태그 - servlet이랑 맞추기 -->
												<tr>
													<td>${v.mid}</td>
													<td>${v.b_title}</td>
